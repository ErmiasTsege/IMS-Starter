...
public class ItemControllerTest {
	...
	public void testCreate() {
		final String PRODUCT_NAME = "table";
		final Double PRICE = 33.00;
		final Item created = new Item(PRODUCT_NAME, PRICE);
	...
	public void testReadAll() {
		...
		items.add(new Item(1L, "Tv", 10.00));
	...
	public void testUpdate() {
		Item updated = new Item(3L, "bed", 332.00);
